...
def load_timel_term_reference(classes_tsv: str) -> Tuple[Dict[str, str], Dict[str, str]]:
    ...
    return normalized_to_canonical, canonical_to_id
...
def run_predict(args: argparse.Namespace) -> None:
    ...
    normalized_to_canonical, canonical_to_id = load_timel_term_reference(args.classes_tsv)
    ...
    print(
        "[PREDICT] Résumé: "
        f"exemples={len(ds)}, total_valid_terms={total_valid}, "
        f"total_invalid_terms={total_invalid}, empty_predictions={empty_predictions}"
    )
